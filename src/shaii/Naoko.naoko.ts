...
import { ban } from "../commands/moderation/ban.naoko";
...
import { highlight, markdown, randomChoice } from "../logic/logic.naoko";
import commandMiddleware from "../middleware/commandMiddleware.naoko";
import { logDelete, logEdit } from "../middleware/messageLoggerMiddleware.naoko";
...
import logger from "./Logger.naoko";
