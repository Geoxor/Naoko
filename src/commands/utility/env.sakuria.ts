...
const LINUX_LOGO = 'https://cdn.discordapp.com/attachments/816028632269979668/878984391936847882/LINUX-LOGO.png';
const SAKURIA_LOGO = 'https://cdn.discordapp.com/avatars/870496144881492069/0cbefb1d82d00b23cff4bc64ba6406d7.png?size=2048';
...
export default defineCommand({
  ...
  execute: (message) => {
    ...
    const embed = new Discord.MessageEmbed()
      .setAuthor(`Sakuria v${version}`, SAKURIA_LOGO)
      .setColor('#FF00B6')
