...
// Update the user's VS Code settings to use the new icons for the shaii files
try {
...
vscodeSettings["material-icon-theme.folders.associations"]["shaii"] = "../../../../icons/shaii-folder";
