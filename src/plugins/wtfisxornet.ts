...
export default definePlugin({
  ...
  command: defineCommand({
    ...
    execute: async (message) => {
      ...
      { // reporter howto
        embed.setTitle("How to install xornet-reporter/How to add machine to xornet")
        .setURL("https://github.com/xornet-cloud/Reporter")
        .setDescription("If you have xornet.cloud account, you can add your machine by installing xornet-reporter. \n\n\n\n ")
        .addField("To install Reporter on Linux, open terminal and run:", "curl https://raw.githubusercontent.com/xornet-cloud/Reporter/main/scripts/install.sh | sudo bash \n\n ")
        .addField("To install Reporter on WIndows, open powershell and run:", 'Set-ExecutionPolicy RemoteSigned -Scope CurrentUser\n iwr -useb get.scoop.sh | iex\n scoop install https://raw.githubusercontent.com/xornet-cloud/Reporter/main/scripts/xornet-reporter.json')
        .addField("To get token:", 'Open web page https://xornet.cloud/ or open client and click "Add machine". \n Copy token and paste it into installer.')
